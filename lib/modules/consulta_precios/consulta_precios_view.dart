...
class ConsultaPreciosView extends GetView<ConsultaPreciosController> {
  const ConsultaPreciosView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Consulta de Precios'),
        centerTitle: true,
        elevation: 0,
        actions: [
          IconButton(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() => Text(
                        controller.sucursalNombre.value,
                        style: TextStyle(
                          fontSize: 18,
